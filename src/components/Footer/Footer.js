...
import { fb, ig, tiktok } from '../../assets'
import './footer.css'
  ...
  return (
    ...
    <section class="footer-top">
      ...
      <div class="redes-sociales text-center">
        <a href="https://es-la.facebook.com/adidasAR/"><img src={fb} alt="Facebook"></img></a>
        <a href="https://www.tiktok.com/@puma"><img src={tiktok} alt="Tiktok"></img></a>
        <a href="https://www.instagram.com/nike/?hl=es"><img src={ig} alt="Instagram"></img></a>
      </div>
    </section>
